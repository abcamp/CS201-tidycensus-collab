...
oahu_family_poverty <- get_acs(
  geography = "tract",
  variables = c(percent_of_families_with_income_below_poverty_line = "DP02_0154P"),
  state = "HI",
  county = "Honolulu",
  geometry = TRUE,
  output = "wide",
...
earth/westernhem/pacific/hawaii/oahu/honolulu/kona/kaimuki/waialae/3140/ching/253.pdf
