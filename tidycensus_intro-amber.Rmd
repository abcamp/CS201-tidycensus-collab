...
(I'm using *9a95ef43f456a0f5bc42fc4a01ea65f2b2940a21)*

```{r Define API Key, message=FALSE}
census_api_key("9a95ef43f456a0f5bc42fc4a01ea65f2b2940a21")
```
...
## Veterans on Oahu (Alex and Rhyn)
...
years2 <- setdiff(2010:2022, c(2020))
names(years2) <- years2

veteran_status_2009_2022 <- map_dfr(years2, ~{
  get_acs(
    geography = "county",
    variables = c(percent_veterans = "DP02_0070P"),
    state = "HI",
...
veteran_status_2009_2022 <- veteran_status_2009_2022 %>%
  add_row(year = "2020", GEOID = "15003", NAME =  "Honolulu County, Hawaii", variable = "percent_veterans") %>%
  arrange(year)
...
ggplot(veteran_status_2009_2022, aes(x = year, y = estimate, group = 1)) + 
  geom_line() + 
  geom_point()
```
...
## Foreign born population in Iowa (Lydia and Faith)
...
years2 <- setdiff(2009:2022, c(2020))
names(years2) <- years2

foreign_born_2009_2022 <- map_dfr(years2, ~{
  get_acs(
    geography = "state",
    variables = c(percent_of_foreign_born_population_by_household = "DP02_0109P"),
    state = "IA",
...
foreign_born_2009_2022 <- foreign_born_2009_2022 %>%
  add_row(year = "2020", GEOID = "19", NAME =  "Iowa", variable = "percent_of_foreign_born_population_by_household") %>%
  arrange(year)


ggplot(foreign_born_2009_2022, aes(x = year, y = estimate, group = 1)) + 
  geom_line() + 
  geom_point()
